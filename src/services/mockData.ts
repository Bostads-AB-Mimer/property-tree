            ...
            children: [
              {
                ...
                type: 'entrance',
                children: [
                  { id: '101', name: 'Lägenhet 101', type: 'residence' },
                  { id: '102', name: 'Lägenhet 102', type: 'residence' },
                ],
              },
              {
                id: 'entrance-2',
                ...
                type: 'entrance',
                children: [
                  { id: '201', name: 'Lägenhet 201', type: 'residence' },
                  { id: '202', name: 'Lägenhet 202', type: 'residence' },
                ],
              },
            ],
          },
...
export const mockResidences: Record<string, Residence> = {
  '101': {
    id: '101',
    name: 'Lägenhet 101',
    address: 'Storgatan 1, Västerås',
  ...
  '102': {
    ...
    rooms: mockRooms['102'],
    activeIssues: mockActiveIssues['102'] || [],
    components: [],
  },
  '201': {
    id: '201',
