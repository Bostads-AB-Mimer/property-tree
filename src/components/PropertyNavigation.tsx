      ...
      >
        <div className="flex items-center space-x-2 flex-1">
          <Icon className={clsx(
            ...
            isSelected ? 'text-blue-500 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-300'
          )} />
...
export function PropertyNavigation() {
  ...
  return (
    <div className="p-4 space-y-2">
      <div className="mb-6">
        <h2 className="text-sm font-medium text-gray-400 dark:text-gray-500 mb-2">Navigation</h2>
