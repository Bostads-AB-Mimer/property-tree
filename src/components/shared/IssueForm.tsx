  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
              ...
              <motion.button
                ...
                className={`
                  ...
                  ${formData.priority === priority.value 
                    ? 'ring-2 ring-offset-2 ring-offset-white dark:ring-offset-gray-800 ' + priority.color
        ...
        {/* Desired Date */}
        <div>
          <label htmlFor="desiredDate" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
